    ...
    <div class="col-md-9">
        <div>
            ...
            <h2>Informations sur le candidat</h2>
                ...
                <?php if(!empty($detailEntretien[0]['idessai'])) { ?>
                    <div class="info">
                        <div class="data">Statut  </div>
                        <div class="point">................................................</div>
                        <div class="data" style="color : green;">Essai 3 mois</div>
                    </div>
                    <div class="info">
                        <div class="data">Date de début  </div>
                        <div class="point">................................................</div>
                        <div class="data">
                            <?php $date = new DateTime($detailEntretien[0]['datedebut']);
                                echo $date->format('d F Y');
                            ?>
                        </div>
                    </div>
                    <div class="info">
                        ...
                        <div class="point">................................................</div>
                        <div class="data">
                            <?php $date = new DateTime($detailEntretien[0]['datefin']);
                                echo $date->format('d F Y');
                            ?>
                        </div>
                    </div>
                ...
                <?php if(!empty($detailEntretien[0]['idcandidatrefuse'])) { ?>
                    <div class="info">    
                        <div class="data">Statut  </div>
                        <div class="point">................................................</div>
                        <div class="data" style="color : red;">Recallé</div>
                    </div>
                <?php } else if (empty($detailEntretien[0]['idcandidatrefuse']) && empty($detailEntretien[0]['idessai'])) { ?>
                    <div class="validation">
                        <a href="<?php echo base_url('annonce/C_Entretien/getDetailEntretien/'.$detailEntretien[0]['identretien']).'/true' ?>">
                            <button class="modifier">VALIDER</button>
                        </a>
                        <a href="<?php echo base_url('annonce/C_Entretien/refuserCandidat/'.$detailEntretien[0]['idcandidat']) ?>">
                            <button class="delete">RECALLER</button>
                        </a>
                    </div>
                <?php } ?>
