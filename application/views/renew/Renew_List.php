    ...
    <form id="pageToGoPoste" action="<?php echo base_url('essai/C_Renew/filtre'); ?>" method="GET">
    ...
    <table class="col-md-10 table">
        ...
        <tbody>
            <?php 
            if (!empty($listeCandidatRenew)) {
                foreach ($listeCandidatRenew as $renew) { ?>
                    <tr class="ligne" data-href="<?php echo base_url('essai/C_Renew/getDetailRenew/'.$renew['idrenouvellement']); ?>">
                        <td><?php echo $renew['idrenouvellement']; ?></td>
                        <td><?php echo $renew['debutrenew']; ?></td>
                        <td><?php echo $renew['finrenew']; ?></td>
                        <td><?php echo $renew['nomposte']; ?></td>
                        <td><?php echo $renew['nom']; ?></td>
                        <td><?php echo $renew['prenom']; ?></td>
                        <td><?php echo $renew['adresse']; ?></td>
                    </tr>
                <?php 
                    }
                } else { ?>
