    ...
    <div class="col-md-9">
        <form action="<?php echo base_url('besoin/C_Besoin/saveValidationDG') ?>" method="POST">   
            <div>
                <h2>Détails de demande de besoin pour le poste de <?php echo $detailBesoin[0]['nomposte']; ?></h2>
                    ...
                    <div class="quantite">
                        ...
                        <input type="date" name="datevalidationdg" class="selectMats" value="<?php echo date('Y-m-d'); ?>">
                        <div class="titleMatiere"></div>
                    </div>
                    
                    <input type="hidden" name="idbesoin" class="selectMats" value="<?php echo $detailBesoin[0]['idbesoin'] ?>">
                    <input type="hidden" name="checkrh" class="selectMats" value="<?php echo $detailBesoin[0]['checkrh'] ?>">
                    <input type="hidden" name="datevalidationrh" class="selectMats" value="<?php echo $detailBesoin[0]['datevalidationrh'] ?>">
                    <input type="hidden" name="moyenne" class="selectMats" value="<?php echo $detailBesoin[0]['averagenoteqcm'] ?>">
                    <input type="hidden" name="nomPoste" class="selectMats" value="<?php echo $detailBesoin[0]['nomposte'] ?>">
