    ...
    <div class="col-md-9">
        <div>
        <form action="<?php echo base_url('essai/C_Renew/embaucheCandidat/1') ?>" method="POST"> 
            ...
            <h2>Informations sur le candidat</h2>
                ...
                <div class="titleMatiere"><h4>Contrat : </h4></div>
                    ...
                    <input type="hidden" name="idcandidat" value="<?php echo $detailEssai[0]['idcandidat'] ?>">
                    <input type="hidden" name="nom" value="<?php echo $detailEssai[0]['nom'] ?>">
                    <input type="hidden" name="prenom" value="<?php echo $detailEssai[0]['prenom'] ?>">
                    <input type="hidden" name="email" value="<?php echo $detailEssai[0]['email'] ?>">
                    <input type="hidden" name="adresse" value="<?php echo $detailEssai[0]['adresse'] ?>">
                    <input type="hidden" name="dtn" value="<?php echo $detailEssai[0]['dtn'] ?>">
                    <input type="hidden" name="poste" value="<?php echo $detailEssai[0]['idposte'] ?>">
                    <input type="hidden" name="diplome" value="<?php echo $detailEssai[0]['id_diplome'] ?>">
                    <input type="hidden" name="besoin" value="<?php echo $detailEssai[0]['idbesoin'] ?>">
